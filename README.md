...
*   **Okamžitá identifikace studentů (Fast-Scan):** Automatická extrakce jména, příjmení a hodnosti ihned po nahrání souboru pomocí dedikované mini-LLM úlohy.
...
*   **Man-in-the-Loop (Lektorské korekce):** Možnost ručního zásahu lektora do bodového hodnocení, zpětné vazby i identity studenta s okamžitou aktualizací statistik a vizuální indikací ověření.
...
*   **Export výsledků:** Generování profesionálních PDF reportů a Excelových přehledů (včetně automatického řazení a pedagogického shrnutí).
